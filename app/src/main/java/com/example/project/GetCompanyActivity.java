...
//            // Add the initial fragment (e.g., CardFragment) to the fragment container
...
//
//        companyDetailsFragment.setCompany(company);
//        companyDetailsFragment.setContext(GetCompanyActivity.this);
//        FragmentManager fragmentManager = getSupportFragmentManager();
//        FragmentTransaction transaction = fragmentManager.beginTransaction();
//        transaction.replace(R.id.fragmentContainer, companyDetailsFragment);
